...
namespace GKToyTaskDialogue
{
    ...
    {
        #region PublicField
        protected new static GKToyDialogueMaker _instance;
        public new static GKToyDialogueMaker Instance
        {
            get
            {
                if (null == _instance)
        ...
        protected new ToyMakerTaskDialogueSettings _settings;
        public new ToyMakerTaskDialogueSettings Settings
        {
            get
            {
                if (_settings == null)
                {
                    _settings = GK.LoadResource<ToyMakerTaskDialogueSettings>("Settings/ToyMakerTaskDialogueSettings");
                }
                return _settings;
            }
        }
