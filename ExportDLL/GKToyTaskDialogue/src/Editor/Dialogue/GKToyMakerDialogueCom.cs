    ...
    public class GKToyMakerDialogueCom : EditorWindow
    {
        ...
        static public GKToyDialogueCameraTypeData CameraTypeData
        {
            get
            {
                ...
                {
                    _cameraTypeData = AssetDatabase.LoadMainAssetAtPath("Assets/Utilities/GKToy/CSV/_AutoGen/GKToyTaskDialogueCameraTypeData.asset") as GKToyDialogueCameraTypeData;
                    if (null == _cameraTypeData)
        ...
        static public GKToyDialogueSoundTypeData SoundTypeData
        {
            get
            {
                ...
                {
                    _soundTypeData = AssetDatabase.LoadMainAssetAtPath("Assets/Utilities/GKToy/CSV/_AutoGen/GKToyTaskDialogueSoundTypeData.asset") as GKToyDialogueSoundTypeData;
                    if (null == _soundTypeData)
