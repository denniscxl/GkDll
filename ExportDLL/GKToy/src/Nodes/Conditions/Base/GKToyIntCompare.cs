...
namespace GKToy
{
    ...
    /// 整型比较.
    /// </summary>
	[NodeTypeTree("条件/基本/整型比较")]
    [NodeTypeTree("Condition/Base/IntCompare", "English")]
	[NodeDescription("判断两整数之间的关系是否满足条件\n若不满足，走第一条连接；若满足，走其他连接")]
	[NodeDescription("Check whether the relation of two integers meet requirement.\nIf true, go to the first link, or go to others.", "English")]
	public class GKToyIntCompare : GKToyNode
	{
        GKToySharedInt _current = 0;
        public GKToySharedInt Current
        {
            get { return _current; }
            set { _current = value; }
        }
        ...
        public GKToyIntCompare(int _id) : base(_id) { }
