...
namespace GKToy
{
    [NodeTypeTree("行为/数学/除法")]
    [NodeTypeTree("Action/Math/Divide", "English")]
    [NodeDescription("基本的除法运算.")]
    [NodeDescription("Basic calculation, Divide.", "English")]
    [NodeIcon("Assets/Utilities/GKToy/Textures/Icon/Calculate.png")]
	public class GKToyDivide : GKToyNode
	{
		[SerializeField]
        ...
        public GKToyDivide(int _id) : base(_id) { }
