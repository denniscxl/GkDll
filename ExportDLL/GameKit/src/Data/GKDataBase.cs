...
namespace GKData
{
    ...
    public class GKDataBase
    {
        ...
        static protected List<GKCommonValue> _changedAttrList = new List<GKCommonValue>();
        static protected List<GKCommonListValue> _changedAttrListList = new List<GKCommonListValue>();
        #endregion
