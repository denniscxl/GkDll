...
namespace GKBase
{
    public class GKSelectObjects : MonoBehaviour
    {
        ...
        Vector3 start = Vector3.zero;   //记下鼠标按下位置.
        bool drawRectangle = false;     //是否开始画线标志.
        ...
        void Update()
        {
            ...
            else if (Input.GetMouseButtonUp(0))
            {
                ...
                _CheckSelection(start, Input.mousePosition);
            }
        }
        ...
        //检测被选择的物体.
        void _CheckSelection(Vector3 start, Vector3 end)
        {
