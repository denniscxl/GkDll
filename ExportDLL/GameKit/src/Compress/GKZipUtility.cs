...
namespace GKCompress
{
    public static class GKZipUtility
    {
        ...
        /// <returns></returns>
        static public bool Zip(string[] _fileOrDirectoryArray, string _outputPathName, int compressLevel = 6, string _password = null, ZipCallback _zipCallback = null)
        {
        ...
        /// <returns></returns>
        static public bool UnzipFile(string _filePathName, string _outputPath, string _password = null, UnzipCallback _unzipCallback = null, bool ignoreEntryName = false)
        {
        ...
        /// <param name="_unzipCallback">UnzipCallback对象，负责回调</param>
        /// <returns></returns>
        static public bool UnzipFile(byte[] _fileBytes, string _outputPath, string _password = null, UnzipCallback _unzipCallback = null, bool ignoreEntryName = false)
        {
        ...
        /// <param name="_unzipCallback">UnzipCallback对象，负责回调</param>
        /// <returns></returns>
        static public bool UnzipFile(Stream _inputStream, string _outputPath, string _password = null, UnzipCallback _unzipCallback = null, bool ignoreEntryName = false)
        {
        ...
        /// <param name="_zipCallback">ZipCallback对象，负责回调</param>
        /// <returns></returns>
        static bool _ZipFile(string _filePathName, string _parentRelPath, ZipOutputStream _zipOutputStream, ZipCallback _zipCallback = null)
        {
        ...
        /// <param name="_zipCallback">ZipCallback对象，负责回调</param>
        /// <returns></returns>
        static bool _ZipDirectory(string _path, string _parentRelPath, ZipOutputStream _zipOutputStream, ZipCallback _zipCallback = null)
        {
            ZipEntry entry = null;
            try
            {
