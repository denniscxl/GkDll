...
namespace GKEncryption
{
    ...
    public class AES
    {
        ...
        static public string AESEncrypt(string EncryptString, string EncryptKey)
        {
        ...
        /// <param name="EncryptString">待加密密文</param>
        /// <param name="EncryptKey">加密密钥</param>
        static public byte[] AESEncrypt(byte[] EncryptByte, string EncryptKey)
        {
        ...
        static public string AESDecrypt(string DecryptString, string DecryptKey)
        {
        ...
        /// <param name="DecryptString">待解密密文</param>
        /// <param name="DecryptKey">解密密钥</param>
        static public byte[] AESDecrypt(byte[] DecryptByte, string DecryptKey)
        {
