...
namespace GKFOW
{
    ...
    public class FOW : GKSingleton<FOW>
    {
        ...
        #region PrivateField
        // 探索/为探索全局索引.
        Dictionary<int, List<int>> _discoveryDict = new Dictionary<int, List<int>>();
        // 以探索区域.
        Dictionary<int, int> _discoveryCount = new Dictionary<int, int>();
        // 效果显示阵营.
        int _myCamp = 0;
        // 探索范围.
        int _size = 0;
        // 视野地块链表.
        List<int> _sightLst = new List<int>();
        #endregion
